                                           ...
                                           std::shared_ptr<BinaryNode<ItemType>> itemNodePtr)
{
   ...
   else
   {
      ...
      {
         rightPtr = balancedAdd(rightPtr , itemNodePtr);
         subTreePtr->setRightChildPtr(rightPtr );
      }
      else
      {
         leftPtr = balancedAdd(leftPtr, itemNodePtr);
...
template<class ItemType>
void BinaryNodeTree<ItemType>::preorder(std::function<void (ItemType&)> visit, std::shared_ptr<BinaryNode<ItemType>> treePtr) const
{
   if (treePtr != nullptr)
   {
...
template<class ItemType>
bool BinaryNodeTree<ItemType>::add(const ItemType& someItem)
{
   auto itemNodePtr = std::make_shared<BinaryNode<ItemType>>(someItem);
...
template<class ItemType>
void BinaryNodeTree<ItemType>::preorderTraverse(std::function<void (ItemType&)> visit) const
{
