...
#include "SortedListAsA.h" // ADT sorted list operations
...
//                  (std::make_unique<LinkedSortedList<std::string>>());
   ...
   do
   {
      ...
      std::cout << "\ta. LinkedSortedList Test\n";
      std::cout << "\tb. SortedListAsA Test\n";
      std::cout << "\tc. SortedListHasA Test\n";
      std::cout << "\td. SortedListIsA Test\n";
      ...
      switch (userSelection) {
         case 'a':
            listPtr = std::make_shared<LinkedSortedList<std::string>>();
         ...
         case 'c':
          ...
          break;
         case 'd':
        //    listPtr = std::make_shared<SortedListIsA<std::string>>();
