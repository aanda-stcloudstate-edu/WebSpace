...
void copyConstructorTester1(std::shared_ptr<LinkedQueue<std::string>> queuePtr);

int main()
{
    std::shared_ptr<QueueInterface<std::string>> queuePtr;
   std::shared_ptr<LinkedQueue<std::string>> lqueuePtr;
   ...
   do
   {
      ...
      switch (userSelection) {
         ...
         case 'b':
            ...
            lqueuePtr = std::make_shared<LinkedQueue<std::string>>();
            copyConstructorTester1(lqueuePtr);
...
void copyConstructorTester1(std::shared_ptr<LinkedQueue<std::string>> queuePtr)
{
   ...
   auto copyOfQueue = std::make_shared<LinkedQueue<std::string>>(*queuePtr);
